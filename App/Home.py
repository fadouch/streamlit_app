...
background-image:
url("https://images.unsplash.com/photo-1515595967223-f9fa59af5a3b?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
...
with col2:
    st.image("téléchargement (1).jpg", width=150, caption="El Fettahi Fadwa - 3CI TOPO", use_column_width=True)
