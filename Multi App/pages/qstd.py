...
def load_map(date, phenomenon, day_offset):
    try:
        ...
        path1 = f"pages/cartes intepolees_cog/{date}_{phenomenon}_{day_offset}_cog.tif"
        path2 = f"pages/cartes intepolees_cog/{date}_{phenomenon}_{day_offset-1}_cog.tif"
